                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{route('kullanici.kaydol')}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="sifre" type="sifre" class="form-control" name="sifre" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="sifre-tekrsri" type="password" class="form-control" name="sifre_confirmation" required>
                                </div>
                            </div>
